...
!(function (o) {
  ...
  (r.SwapColor = o(r.BaseFilter, {
    ...
    applyTo2d: function (o) {
      for (
        var r = o.imageData.data,
          e = r.length,
          t = new c.Color(this.colorSource).getSource(),
          n = new c.Color(this.colorDestination).getSource(),
          i = 0;
        i < e;
        i += 4
      )
    ...
    sendUniformData: function (o, r) {
      ...
      (e[0] /= 255),
        ...
        (t[1] /= 255),
        (t[2] /= 255),
        o.uniform4fv(r.uColorSource, e),
        o.uniform4fv(r.uColorDestination, t);
    },
    ...
    (c.Image.filters.SwapColor.fromObject =
      c.Image.filters.BaseFilter.fromObject);
})("undefined" != typeof exports ? exports : this);

/* COUNTER */
!(function () {
  "use strict";
  $.fn.palleonCounter = function (n) {
    var a = $(this),
      i = a.find(".counter-minus"),
      t = a.find("input"),
      e = a.find(".counter-plus"),
      l = {
        writable: !0,
        minimum: 1,
        maximize: null,
      ...
      s = u.onMinimum,
      c = u.onMaximize;
    $.isNumeric(r) || (r = l.minimum), $.isNumeric(m) || (m = l.maximize);
    var p,
      l = t.val();
    function v(n) {
      t.attr("data-num", n),
        ...
        e.prop("disabled", !1),
        n <= r
          ? (i.prop("disabled", !0), s.call(n.target, n))
          : null != m &&
            m <= n &&
            (e.prop("disabled", !0), c.call(n.target, n)),
        o.call(n.target, n);
    }
    return (
      isNaN(parseInt(l)) && (l = t.val(0).val()),
      n || t.prop("disabled", !0),
      v(l),
      t.val(l),
      i.click(function () {
        var n = parseInt(t.val());
        r < n && (t.val(n - u.step), v(n - u.step));
      }),
      e.click(function () {
        var n = parseInt(t.val());
        (null == m || n < m) && (t.val(n + u.step), v(n + u.step));
      }),
      t.keyup(function () {
        clearTimeout(p),
          (p = setTimeout(function () {
            ...
            "" == n && ((n = r), t.val(r));
            var a = new RegExp("^[\\d]*$");
            isNaN(parseInt(n)) || !a.test(n)
              ? (t.val(t.attr("data-num")), v(t.attr("data-num")))
              : n < r
              ? (t.val(r), v(r))
              : null != m && m < n
              ? (t.val(m), v(m))
...
!(function (v) {
  ...
  v.fn.tmpointer = function (i) {
    ...
    v("body").append(
      '<div id="tm-cursor-' + n.id + '" class="' + n.cursor_class + '"></div>'
    ),
      s.addClass("tm-pointer-wrapper");
    var r,
      t = !1,
      c = 0,
      a = 0,
      u = 0,
      m = 0;
    (r = v("body").find("#tm-cursor-" + n.id)).css(
      "width",
      n.cursorSize + "px"
    ),
      r.css("height", n.cursorSize + "px"),
      r.css("background-color", n.cursorColor + "px");
    var d = n.cursorSize / 2,
      l = n.cursorSize / 2;
    function b() {
      t = !1;
    }
    "disable" == n.native_cursor && s.addClass("tm-cursor-none"),
      "ontouchstart" in window && (r.remove(), s.removeClass("tm-cursor-none")),
      v("body").on("mousemove", function (i) {
        (t = !0),
          "enable" === n.cursor && ((c = i.clientX - d), (a = i.clientY - l)),
          "enable" === n.hide_mode &&
            (clearTimeout(e), (e = setTimeout(b, n.hide_timing))),
          s.is("body") &&
            (v("body")
              .find(".tm-pointer-wrapper")
      ...
      (o = requestAnimationFrame(function i() {
        !0 === t
          ? "enable" === n.cursor &&
            (r.addClass("moving"),
            (u += (c - u) * n.cursor_velocity),
            (m += (a - m) * n.cursor_velocity),
            r.css({ left: u + "px", top: m + "px" }))
          : ("enable" === n.cursor && r.removeClass("moving"),
  ...
  fabric.util.object.extend(fabric.Group.prototype, {
          ...
          t.getObjects("path").forEach(function (e) {
            ...
            fabric.util.applyTransformToObject(e, t),
              r
                ? r.clone(
                    function (t) {
                      t = fabric.EraserBrush.prototype.applyClipPathToPath.call(
                        fabric.EraserBrush.prototype,
                        e,
                        t,
                        a
    ...
    (fabric.Eraser = fabric.util.createClass(fabric.Group, {
      ...
      _toSVG: function (t) {
        ...
        for (var a = 0, i = this._objects.length; a < i; a++)
          e.push("\t\t", this._objects[a].toSVG(t));
        return e.push("</g>\n"), e;
      },
    })),
    (fabric.Eraser.fromObject = function (r, a) {
      ...
      fabric.util.enlivenObjects(t, function (t) {
        ...
        delete e.objects,
          fabric.util.enlivenObjectEnlivables(r, e, function () {
  ...
  fabric.util.object.extend(fabric.Canvas.prototype, {
    ...
    (fabric.EraserBrush = fabric.util.createClass(fabric.PencilBrush, {
      ...
      _prepareCollectionTraversal: function (e, r, a) {
        e.forEachObject(function (t) {
          t.forEachObject && "deep" === t.erasable
            ? this._prepareCollectionTraversal(t, r, a)
            ...
            : this.inverted &&
              ...
              (t.erasable && t.eraser
                ? ((t.eraser.inverted = !0),
                  ...
                  (e.dirty = !0),
                  a.eraser.push(t))
                : ((t.visible = !1), (e.dirty = !0), a.visibility.push(t)),
              a.collection.push(e));
        }, this);
      },
      preparePattern: function () {
        ...
        !this.inverted && ((r && !a) || this.canvas.backgroundColor)
          ? (a && (this.canvas.backgroundImage = void 0),
            this.canvas._renderBackground(e),
            a && (this.canvas.backgroundImage = r))
          : this.inverted &&
            r &&
            a &&
            ((s = this.canvas.backgroundColor),
            (this.canvas.backgroundColor = void 0),
            this.canvas._renderBackground(e),
            (this.canvas.backgroundColor = s)),
          e.save(),
          e.transform.apply(e, this.canvas.viewportTransform);
        var s,
          a = { visibility: [], eraser: [], collection: [] };
        this._prepareCollectionTraversal(this.canvas, e, a),
          this.canvas._renderObjects(e, this.canvas._objects),
          a.visibility.forEach(function (t) {
            t.visible = !0;
          }),
          ...
          e.restore(),
          !this.inverted && ((i && !t) || this.canvas.overlayColor)
            ? (t && (this.canvas.overlayImage = void 0),
              c.call(this.canvas, e),
              t && (this.canvas.overlayImage = i))
            : this.inverted &&
              i &&
              t &&
              ((s = this.canvas.overlayColor),
              (this.canvas.overlayColor = void 0),
              c.call(this.canvas, e),
              (this.canvas.overlayColor = s));
      },
      ...
      applyClipPathToPath: function (t, e, r) {
        var a = fabric.util.invertTransform(t.calcTransformMatrix()),
          ...
          r = e.absolutePositioned
            ? a
            : fabric.util.multiplyTransformMatrices(a, r);
        return (
      ...
      _addPathToObjectEraser: function (r, e) {
        ...
        r.forEachObject && "deep" === r.erasable
          ? 0 <
              (t = r._objects.filter(function (t) {
                return t.erasable;
              })).length && r.clipPath
            ? this.clonePathWithClipPath(e, r, function (e) {
                t.forEach(function (t) {
          ...
          : ((a = r.eraser) || ((a = new fabric.Eraser()), (r.eraser = a)),
            e.clone(function (t) {
              ...
              fabric.util.applyTransformToObject(t, e),
                a.addWithUpdate(t),
                r.set("dirty", !0),
                r.fire("erasing:end", { path: t }),
                r.group &&
                  Array.isArray(i.__subTargets) &&
                  i.__subTargets.push(r);
            }));
      },
      ...
      _finalizeAndAddPath: function () {
        ...
        e.forEachObject(function (t) {
          t.erasable &&
            ...
            (a._addPathToObjectEraser(t, r), i.push(t));
        }),
          e.fire("erasing:end", {
            path: r,
            targets: i,
